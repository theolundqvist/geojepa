...
def cosine_decay_schedule(init, end, progress):
    return 0.5 * (1 + math.cos(math.pi * progress)) * (init - end) + end


class REXScheduler(optim.lr_scheduler.LRScheduler):
