...
const ::uint32_t TableStruct_processed_5ftile_5fgroup_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    ~0u,  // no _has_bits_
    PROTOBUF_FIELD_OFFSET(::processed::Feature, _internal_metadata_),
    ~0u,  // no _extensions_
    ~0u,  // no _oneof_case_
    ...
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::processed::Feature, _impl_.tags_),
    PROTOBUF_FIELD_OFFSET(::processed::Feature, _impl_.min_box_),
    PROTOBUF_FIELD_OFFSET(::processed::Feature, _impl_.area_),
    PROTOBUF_FIELD_OFFSET(::processed::Feature, _impl_.width_),
    PROTOBUF_FIELD_OFFSET(::processed::Feature, _impl_.height_),
    PROTOBUF_FIELD_OFFSET(::processed::Feature, _impl_.rotation_),
    PROTOBUF_FIELD_OFFSET(::processed::Feature, _impl_.is_point_),
    PROTOBUF_FIELD_OFFSET(::processed::Feature, _impl_.is_polyline_),
    PROTOBUF_FIELD_OFFSET(::processed::Feature, _impl_.is_polygon_),
    PROTOBUF_FIELD_OFFSET(::processed::Feature, _impl_.is_relation_),
    ~0u,  // no _has_bits_
    PROTOBUF_FIELD_OFFSET(::processed::Tile, _internal_metadata_),
    ~0u,  // no _extensions_
    ~0u,  // no _oneof_case_
    ~0u,  // no _weak_field_map_
    ~0u,  // no _inlined_string_donated_
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::processed::Tile, _impl_.nodes_),
    PROTOBUF_FIELD_OFFSET(::processed::Tile, _impl_.local_coords_),
    PROTOBUF_FIELD_OFFSET(::processed::Tile, _impl_.inter_edges_),
    PROTOBUF_FIELD_OFFSET(::processed::Tile, _impl_.intra_edges_),
    PROTOBUF_FIELD_OFFSET(::processed::Tile, _impl_.node_to_feature_),
    PROTOBUF_FIELD_OFFSET(::processed::Tile, _impl_.features_),
    PROTOBUF_FIELD_OFFSET(::processed::Tile, _impl_.zoom_),
    PROTOBUF_FIELD_OFFSET(::processed::Tile, _impl_.x_),
    PROTOBUF_FIELD_OFFSET(::processed::Tile, _impl_.y_),
    ~0u,  // no _has_bits_
    PROTOBUF_FIELD_OFFSET(::processed::TileGroup, _internal_metadata_),
    ~0u,  // no _extensions_
    ~0u,  // no _oneof_case_
    ~0u,  // no _weak_field_map_
    ~0u,  // no _inlined_string_donated_
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::processed::TileGroup, _impl_.zoom_),
    PROTOBUF_FIELD_OFFSET(::processed::TileGroup, _impl_.x_),
    PROTOBUF_FIELD_OFFSET(::processed::TileGroup, _impl_.y_),
    PROTOBUF_FIELD_OFFSET(::processed::TileGroup, _impl_.tiles_),
};

static const ::_pbi::MigrationSchema
    schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
        {0, -1, -1, sizeof(::processed::Feature)},
        {18, -1, -1, sizeof(::processed::Tile)},
        {35, -1, -1, sizeof(::processed::TileGroup)},
};

static const ::_pb::Message* const file_default_instances[] = {
    &::processed::_Feature_default_instance_._instance,
    &::processed::_Tile_default_instance_._instance,
    &::processed::_TileGroup_default_instance_._instance,
};
const char descriptor_table_protodef_processed_5ftile_5fgroup_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    "\n\032processed_tile_group.proto\022\tprocessed\""
    "\267\001\n\007Feature\022\014\n\004tags\030\001 \003(\t\022\017\n\007min_box\030\002 \003"
    "(\002\022\014\n\004area\030\003 \001(\002\022\r\n\005width\030\004 \001(\002\022\016\n\006heigh"
    "t\030\005 \001(\002\022\020\n\010rotation\030\006 \001(\002\022\020\n\010is_point\030\007 "
    "\001(\010\022\023\n\013is_polyline\030\010 \001(\010\022\022\n\nis_polygon\030\t"
    " \001(\010\022\023\n\013is_relation\030\n \001(\010\"\270\001\n\004Tile\022\r\n\005no"
    "des\030\001 \003(\002\022\024\n\014local_coords\030\002 \003(\002\022\023\n\013inter"
    "_edges\030\003 \003(\005\022\023\n\013intra_edges\030\004 \003(\005\022\027\n\017nod"
    "e_to_feature\030\005 \003(\005\022$\n\010features\030\006 \003(\0132\022.p"
    "rocessed.Feature\022\014\n\004zoom\030\007 \001(\005\022\t\n\001x\030\010 \001("
    "\005\022\t\n\001y\030\t \001(\005\"O\n\tTileGroup\022\014\n\004zoom\030\001 \001(\005\022"
    "\t\n\001x\030\002 \001(\005\022\t\n\001y\030\003 \001(\005\022\036\n\005tiles\030\004 \003(\0132\017.p"
    "rocessed.Tileb\006proto3"
};
...
Feature::Feature(::google::protobuf::Arena* arena)
  ...
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:processed.Feature)
}
...
Feature::Feature(
  ...
  // @@protoc_insertion_point(copy_constructor:processed.Feature)
}
inline PROTOBUF_NDEBUG_INLINE Feature::Impl_::Impl_(
...
Feature::~Feature() {
  // @@protoc_insertion_point(destructor:processed.Feature)
...
// @@protoc_insertion_point(message_clear_start:processed.Feature)
...
const ::_pbi::TcParseTable<4, 10, 0, 38, 2> Feature::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
...
::uint8_t* Feature::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:processed.Feature)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  for (int i = 0, n = this->_internal_tags_size(); i < n; ++i) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        s.data(), static_cast<int>(s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "processed.Feature.tags");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:processed.Feature)
  return target;
}

::size_t Feature::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:processed.Feature)
  ::size_t total_size = 0;
...
void Feature::MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:processed.Feature)
...
// @@protoc_insertion_point(class_specific_copy_from_start:processed.Feature)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
Tile::Tile(::google::protobuf::Arena* arena)
    : ::google::protobuf::Message(arena) {
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:processed.Tile)
}
...
Tile::Tile(
  ...
  // @@protoc_insertion_point(copy_constructor:processed.Tile)
}
inline PROTOBUF_NDEBUG_INLINE Tile::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* arena)
...
Tile::~Tile() {
  // @@protoc_insertion_point(destructor:processed.Tile)
  _internal_metadata_.Delete<::google::protobuf::UnknownFieldSet>();
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:processed.Tile)
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const ::_pbi::TcParseTable<4, 9, 1, 0, 2> Tile::_table_ = {
  {
    ...
    {::_pbi::TcParser::GetTable<::processed::Feature>()},
  }}, {{
  }},
};
...
::uint8_t* Tile::_InternalSerialize(
    ::uint8_t* target,
    ::google::protobuf::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:processed.Tile)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:processed.Tile)
  return target;
}

::size_t Tile::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:processed.Tile)
  ::size_t total_size = 0;
...
void Tile::MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:processed.Tile)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:processed.Tile)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
TileGroup::TileGroup(::google::protobuf::Arena* arena)
    : ::google::protobuf::Message(arena) {
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:processed.TileGroup)
}
...
TileGroup::TileGroup(
  ...
  // @@protoc_insertion_point(copy_constructor:processed.TileGroup)
}
inline PROTOBUF_NDEBUG_INLINE TileGroup::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* arena)
...
TileGroup::~TileGroup() {
  // @@protoc_insertion_point(destructor:processed.TileGroup)
  _internal_metadata_.Delete<::google::protobuf::UnknownFieldSet>();
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:processed.TileGroup)
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const ::_pbi::TcParseTable<2, 4, 1, 0, 2> TileGroup::_table_ = {
  {
    ...
    {::_pbi::TcParser::GetTable<::processed::Tile>()},
  }}, {{
  }},
};
...
::uint8_t* TileGroup::_InternalSerialize(
    ::uint8_t* target,
    ::google::protobuf::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:processed.TileGroup)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:processed.TileGroup)
  return target;
}

::size_t TileGroup::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:processed.TileGroup)
  ::size_t total_size = 0;
...
void TileGroup::MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:processed.TileGroup)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:processed.TileGroup)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
